...
(function(){
  ...
  const minutesDelay = 0.01 //31.36; 8 // change this value to control when the buy area appears
    ...
    const expiryMinutes = 44; //30; // default 30 minutes (change to 60 for 60 minutes)
